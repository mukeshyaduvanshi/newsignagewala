...
import { useVendorRolePermissions } from "@/lib/hooks/useVendorRolePermissions"
...
const ComponentsRolePermissionList = ({ onEdit }: RolePermissionListProps) => {
  const { authorities, isLoading, isError, mutate } = useVendorRolePermissions()
  ...
  const handleDelete = async (id: string) => {
    ...
    setDeletingId(id)
    try {
      const response = await fetch("/api/vendor/role-permissions/delete", {
        method: "DELETE",
        headers: {
