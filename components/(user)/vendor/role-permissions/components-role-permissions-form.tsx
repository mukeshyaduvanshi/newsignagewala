...
const ComponentsRolePermissionForm = ({ editData, onCancelEdit }: RolePermissionFormProps) => {
  ...
  const { mutate } = useVendorRolePermissions()
  const { authorities: teamAuthorities, isLoading: teamLoading } = useVendorUserRoles()
  ...
  const onSubmit = async (data: RolePermissionFormValues) => {
    ...
    try {
      const endpoint = isEditMode
        ? "/api/vendor/role-permissions/put"
        : "/api/vendor/role-permissions/post"
