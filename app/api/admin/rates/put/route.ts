...
export async function PUT(req: NextRequest) {
  try {
    ...
    const { id, labelName, description, rate, measurementUnit, calculateUnit, rateType, width, height, imageUrl } = body
    ...
    if (oldUniqueKey) {
      ...
      console.log(`Updated ${brandUpdateResult.modifiedCount} brand rates with uniqueKey: ${oldUniqueKey}`);
    }
