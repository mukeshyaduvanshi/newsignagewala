...
export async function POST(req: NextRequest) {
  try {
    ...
    const storeIdToUpdate = typeof racee.storeId === 'object' ? racee.storeId._id : racee.storeId;
    ...
    if (storeIdToUpdate) {
      ...
      if (racee.storeLocation && racee.storeLocation.coordinates && racee.storeLocation.coordinates.length > 0) {
