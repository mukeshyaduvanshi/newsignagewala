...
import ComponentsRolePermissionsForm from '@/components/(user)/vendor/role-permissions/components-role-permissions-form'
import ComponentsRolePermissionsList from '@/components/(user)/vendor/role-permissions/components-role-permissions-list'
